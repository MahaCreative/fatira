...
class RegistrasiMahasiswaController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $pdpt = $request->file('pdpt') ? $request->file('pdpt')->store($request->nim.'public/File_Regis/pdpt') : null;
        $krs = $request->file('krs') ? $request->file('krs')->store($request->nim.'public/File_Regis/krs') : null;
        $blanko = $request->file('blanko') ? $request->file('blanko')->store($request->nim.'public/File_Regis/blanko') : null;
        $kwitansi = $request->file('kwitansi') ? $request->file('kwitansi')->store($request->nim.'public/File_Regis/kwitansi') : null;
